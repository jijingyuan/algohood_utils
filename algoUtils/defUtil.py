...
class SignalBase(abc.ABC):
    ...
    @abc.abstractmethod
    def generate_signals(self, _data: Dict[str, List[List]]) -> Optional[List[Dict[str, str]]]:
        """
        generate signal to execution module
...
class InterceptBase(abc.ABC):  # 继承 abc.ABC
    
    @abc.abstractmethod
    def generate_features(self, _data: Dict[str, List[List]]) -> Optional[Dict[str, float]]:
        """
    ...
    @abc.abstractmethod
    def generate_model(self, _fnts: List[Dict[str, Dict[str, float]]]) -> None:
        """
    ...
    @abc.abstractmethod
    def intercept_signal(self, _features: Dict[str, float]) -> bool:
        """
        check whether or not to intercept signal base on the model forcast
        :param _features: features that is generated by generate_features
